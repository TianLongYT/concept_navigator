...
class EditingParentDomainPanel extends StatefulWidget {
  const EditingParentDomainPanel({super.key});

  @override
  State<EditingParentDomainPanel> createState() => _EditingParentDomainPanelState();
}

class _EditingParentDomainPanelState extends State<EditingParentDomainPanel> {
  ...
  Widget build(BuildContext context) {
    ...
    StatefulComponentManagerModel statefulComponentManagerModel = statefulComponentManagerModelForProvider.editingParentDomainPanel;
