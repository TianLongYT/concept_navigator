...
class LevelNode extends StatelessWidget {
  ...
  LevelNode({super.key, required this.drawingData, required this.nodeTree}):
  ...
  Widget build(BuildContext context) {
    ...
    Size size = drawingData.nodeAppearance.nodeSize * drawingData.nodeAppearance.emptySize;
    return
      SizedBox(
        child: CustomPaint(
          size: size,
...
class NodePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final Rect coreRect = Rect.fromLTWH(emptyRadio * coreSize.width, emptyRadio * coreSize.height, coreSize.width, coreSize.height);//Rect.fromCenter(center : Offset(0,0),width:  nodeAppearance.nodeSize.width,height: nodeAppearance.nodeSize.height);
